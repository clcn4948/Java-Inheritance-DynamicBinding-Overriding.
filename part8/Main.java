...
public class Main {
 ...
 // mixed
 { Seq s = Plus.plus(c2,d4); System.out.println("s="+ "Plus.plus(c2,d4)" + ";"); 
             System.out.print( "Plus.plus(c2,d4)" + ":"); 
             System.out.print(Plus.plus(c2,d4)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(c2,d4) instanceof Constant" + ":" + ((Seq)Plus.plus(c2,d4) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(c2,d4) instanceof Delta" + ":" + ((Seq)Plus.plus(c2,d4) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(c2,d4) instanceof Jumble" + ":" + ((Seq)Plus.plus(c2,d4) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(c2,d4).min()" + ":" + (Plus.plus(c2,d4).min()) + ":"); };
 { Seq s = Plus.plus(d4,c2); System.out.println("s="+ "Plus.plus(d4,c2)" + ";"); 
             System.out.print( "Plus.plus(d4,c2)" + ":"); 
             System.out.print(Plus.plus(d4,c2)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(d4,c2) instanceof Constant" + ":" + ((Seq)Plus.plus(d4,c2) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(d4,c2) instanceof Delta" + ":" + ((Seq)Plus.plus(d4,c2) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(d4,c2) instanceof Jumble" + ":" + ((Seq)Plus.plus(d4,c2) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(d4,c2).min()" + ":" + (Plus.plus(d4,c2).min()) + ":"); };
 { Seq s = Plus.plus(c1,d1); System.out.println("s="+ "Plus.plus(c1,d1)" + ";"); 
             System.out.print( "Plus.plus(c1,d1)" + ":"); 
             System.out.print(Plus.plus(c1,d1)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(c1,d1) instanceof Constant" + ":" + ((Seq)Plus.plus(c1,d1) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(c1,d1) instanceof Delta" + ":" + ((Seq)Plus.plus(c1,d1) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(c1,d1) instanceof Jumble" + ":" + ((Seq)Plus.plus(c1,d1) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(c1,d1).min()" + ":" + (Plus.plus(c1,d1).min()) + ":"); };
 { Seq s = Plus.plus(d1,c1); System.out.println("s="+ "Plus.plus(d1,c1)" + ";"); 
             System.out.print( "Plus.plus(d1,c1)" + ":"); 
             System.out.print(Plus.plus(d1,c1)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(d1,c1) instanceof Constant" + ":" + ((Seq)Plus.plus(d1,c1) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(d1,c1) instanceof Delta" + ":" + ((Seq)Plus.plus(d1,c1) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(d1,c1) instanceof Jumble" + ":" + ((Seq)Plus.plus(d1,c1) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(d1,c1).min()" + ":" + (Plus.plus(d1,c1).min()) + ":"); };
 { Seq s = Plus.plus(d8,c1); System.out.println("s="+ "Plus.plus(d8,c1)" + ";"); 
             System.out.print( "Plus.plus(d8,c1)" + ":"); 
             System.out.print(Plus.plus(d8,c1)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(d8,c1) instanceof Constant" + ":" + ((Seq)Plus.plus(d8,c1) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(d8,c1) instanceof Delta" + ":" + ((Seq)Plus.plus(d8,c1) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(d8,c1) instanceof Jumble" + ":" + ((Seq)Plus.plus(d8,c1) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(d8,c1).min()" + ":" + (Plus.plus(d8,c1).min()) + ":"); };
 { Seq s = Plus.plus(d8,c6); System.out.println("s="+ "Plus.plus(d8,c6)" + ";"); 
             System.out.print( "Plus.plus(d8,c6)" + ":"); 
             System.out.print(Plus.plus(d8,c6)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(d8,c6) instanceof Constant" + ":" + ((Seq)Plus.plus(d8,c6) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(d8,c6) instanceof Delta" + ":" + ((Seq)Plus.plus(d8,c6) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(d8,c6) instanceof Jumble" + ":" + ((Seq)Plus.plus(d8,c6) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(d8,c6).min()" + ":" + (Plus.plus(d8,c6).min()) + ":"); };
 { Seq s = Plus.plus(c8,d6); System.out.println("s="+ "Plus.plus(c8,d6)" + ";"); 
             System.out.print( "Plus.plus(c8,d6)" + ":"); 
             System.out.print(Plus.plus(c8,d6)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(c8,d6) instanceof Constant" + ":" + ((Seq)Plus.plus(c8,d6) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(c8,d6) instanceof Delta" + ":" + ((Seq)Plus.plus(c8,d6) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(c8,d6) instanceof Jumble" + ":" + ((Seq)Plus.plus(c8,d6) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(c8,d6).min()" + ":" + (Plus.plus(c8,d6).min()) + ":"); };
 { Seq s = Plus.plus(c2,j1); System.out.println("s="+ "Plus.plus(c2,j1)" + ";"); 
             System.out.print( "Plus.plus(c2,j1)" + ":"); 
             System.out.print(Plus.plus(c2,j1)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(c2,j1) instanceof Constant" + ":" + ((Seq)Plus.plus(c2,j1) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(c2,j1) instanceof Delta" + ":" + ((Seq)Plus.plus(c2,j1) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(c2,j1) instanceof Jumble" + ":" + ((Seq)Plus.plus(c2,j1) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(c2,j1).min()" + ":" + (Plus.plus(c2,j1).min()) + ":"); };
 { Seq s = Plus.plus(j1,c2); System.out.println("s="+ "Plus.plus(j1,c2)" + ";"); 
             System.out.print( "Plus.plus(j1,c2)" + ":"); 
             System.out.print(Plus.plus(j1,c2)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(j1,c2) instanceof Constant" + ":" + ((Seq)Plus.plus(j1,c2) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(j1,c2) instanceof Delta" + ":" + ((Seq)Plus.plus(j1,c2) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(j1,c2) instanceof Jumble" + ":" + ((Seq)Plus.plus(j1,c2) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(j1,c2).min()" + ":" + (Plus.plus(j1,c2).min()) + ":"); };
 { Seq s = Plus.plus(c6,j3); System.out.println("s="+ "Plus.plus(c6,j3)" + ";"); 
             System.out.print( "Plus.plus(c6,j3)" + ":"); 
             System.out.print(Plus.plus(c6,j3)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(c6,j3) instanceof Constant" + ":" + ((Seq)Plus.plus(c6,j3) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(c6,j3) instanceof Delta" + ":" + ((Seq)Plus.plus(c6,j3) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(c6,j3) instanceof Jumble" + ":" + ((Seq)Plus.plus(c6,j3) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(c6,j3).min()" + ":" + (Plus.plus(c6,j3).min()) + ":"); };
 { Seq s = Plus.plus(j3,c6); System.out.println("s="+ "Plus.plus(j3,c6)" + ";"); 
             System.out.print( "Plus.plus(j3,c6)" + ":"); 
             System.out.print(Plus.plus(j3,c6)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(j3,c6) instanceof Constant" + ":" + ((Seq)Plus.plus(j3,c6) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(j3,c6) instanceof Delta" + ":" + ((Seq)Plus.plus(j3,c6) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(j3,c6) instanceof Jumble" + ":" + ((Seq)Plus.plus(j3,c6) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(j3,c6).min()" + ":" + (Plus.plus(j3,c6).min()) + ":"); };
 { Seq s = Plus.plus(d2,j4); System.out.println("s="+ "Plus.plus(d2,j4)" + ";"); 
             System.out.print( "Plus.plus(d2,j4)" + ":"); 
             System.out.print(Plus.plus(d2,j4)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(d2,j4) instanceof Constant" + ":" + ((Seq)Plus.plus(d2,j4) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(d2,j4) instanceof Delta" + ":" + ((Seq)Plus.plus(d2,j4) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(d2,j4) instanceof Jumble" + ":" + ((Seq)Plus.plus(d2,j4) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(d2,j4).min()" + ":" + (Plus.plus(d2,j4).min()) + ":"); };
 { Seq s = Plus.plus(c6,j4); System.out.println("s="+ "Plus.plus(c6,j4)" + ";"); 
             System.out.print( "Plus.plus(c6,j4)" + ":"); 
             System.out.print(Plus.plus(c6,j4)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(c6,j4) instanceof Constant" + ":" + ((Seq)Plus.plus(c6,j4) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(c6,j4) instanceof Delta" + ":" + ((Seq)Plus.plus(c6,j4) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(c6,j4) instanceof Jumble" + ":" + ((Seq)Plus.plus(c6,j4) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(c6,j4).min()" + ":" + (Plus.plus(c6,j4).min()) + ":"); };
 { Seq s = Plus.plus(d6,j4); System.out.println("s="+ "Plus.plus(d6,j4)" + ";"); 
             System.out.print( "Plus.plus(d6,j4)" + ":"); 
             System.out.print(Plus.plus(d6,j4)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(d6,j4) instanceof Constant" + ":" + ((Seq)Plus.plus(d6,j4) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(d6,j4) instanceof Delta" + ":" + ((Seq)Plus.plus(d6,j4) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(d6,j4) instanceof Jumble" + ":" + ((Seq)Plus.plus(d6,j4) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(d6,j4).min()" + ":" + (Plus.plus(d6,j4).min()) + ":"); };
 { Seq s = Plus.plus(d8,j4); System.out.println("s="+ "Plus.plus(d8,j4)" + ";"); 
             System.out.print( "Plus.plus(d8,j4)" + ":"); 
             System.out.print(Plus.plus(d8,j4)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(d8,j4) instanceof Constant" + ":" + ((Seq)Plus.plus(d8,j4) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(d8,j4) instanceof Delta" + ":" + ((Seq)Plus.plus(d8,j4) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(d8,j4) instanceof Jumble" + ":" + ((Seq)Plus.plus(d8,j4) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(d8,j4).min()" + ":" + (Plus.plus(d8,j4).min()) + ":"); };
 { Seq s = Plus.plus(d6,h7); System.out.println("s="+ "Plus.plus(d6,h7)" + ";"); 
             System.out.print( "Plus.plus(d6,h7)" + ":"); 
             System.out.print(Plus.plus(d6,h7)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(d6,h7) instanceof Constant" + ":" + ((Seq)Plus.plus(d6,h7) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(d6,h7) instanceof Delta" + ":" + ((Seq)Plus.plus(d6,h7) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(d6,h7) instanceof Jumble" + ":" + ((Seq)Plus.plus(d6,h7) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(d6,h7).min()" + ":" + (Plus.plus(d6,h7).min()) + ":"); };
 { Seq s = Plus.plus(d6,h8); System.out.println("s="+ "Plus.plus(d6,h8)" + ";"); 
             System.out.print( "Plus.plus(d6,h8)" + ":"); 
             System.out.print(Plus.plus(d6,h8)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(d6,h8) instanceof Constant" + ":" + ((Seq)Plus.plus(d6,h8) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(d6,h8) instanceof Delta" + ":" + ((Seq)Plus.plus(d6,h8) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(d6,h8) instanceof Jumble" + ":" + ((Seq)Plus.plus(d6,h8) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(d6,h8).min()" + ":" + (Plus.plus(d6,h8).min()) + ":"); };
 { Seq s = Plus.plus(d6,h9); System.out.println("s="+ "Plus.plus(d6,h9)" + ";"); 
             System.out.print( "Plus.plus(d6,h9)" + ":"); 
             System.out.print(Plus.plus(d6,h9)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(d6,h9) instanceof Constant" + ":" + ((Seq)Plus.plus(d6,h9) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(d6,h9) instanceof Delta" + ":" + ((Seq)Plus.plus(d6,h9) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(d6,h9) instanceof Jumble" + ":" + ((Seq)Plus.plus(d6,h9) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(d6,h9).min()" + ":" + (Plus.plus(d6,h9).min()) + ":"); };
 { Seq s = Plus.plus(c1,h9); System.out.println("s="+ "Plus.plus(c1,h9)" + ";"); 
             System.out.print( "Plus.plus(c1,h9)" + ":"); 
             System.out.print(Plus.plus(c1,h9)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(c1,h9) instanceof Constant" + ":" + ((Seq)Plus.plus(c1,h9) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(c1,h9) instanceof Delta" + ":" + ((Seq)Plus.plus(c1,h9) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(c1,h9) instanceof Jumble" + ":" + ((Seq)Plus.plus(c1,h9) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(c1,h9).min()" + ":" + (Plus.plus(c1,h9).min()) + ":"); };
 { Seq s = Plus.plus(c1,h8); System.out.println("s="+ "Plus.plus(c1,h8)" + ";"); 
             System.out.print( "Plus.plus(c1,h8)" + ":"); 
             System.out.print(Plus.plus(c1,h8)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(c1,h8) instanceof Constant" + ":" + ((Seq)Plus.plus(c1,h8) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(c1,h8) instanceof Delta" + ":" + ((Seq)Plus.plus(c1,h8) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(c1,h8) instanceof Jumble" + ":" + ((Seq)Plus.plus(c1,h8) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(c1,h8).min()" + ":" + (Plus.plus(c1,h8).min()) + ":"); };
 { Seq s = Plus.plus(c6,h7); System.out.println("s="+ "Plus.plus(c6,h7)" + ";"); 
             System.out.print( "Plus.plus(c6,h7)" + ":"); 
             System.out.print(Plus.plus(c6,h7)); 
             System.out.println(":"); 
             System.out.println( "(Seq)Plus.plus(c6,h7) instanceof Constant" + ":" + ((Seq)Plus.plus(c6,h7) instanceof Constant) + ":"); 
             System.out.println( "(Seq)Plus.plus(c6,h7) instanceof Delta" + ":" + ((Seq)Plus.plus(c6,h7) instanceof Delta) + ":"); 
             System.out.println( "(Seq)Plus.plus(c6,h7) instanceof Jumble" + ":" + ((Seq)Plus.plus(c6,h7) instanceof Jumble) + ":"); 
             System.out.println( "Plus.plus(c6,h7).min()" + ":" + (Plus.plus(c6,h7).min()) + ":"); };
 System.exit(0);
    }
